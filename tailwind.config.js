...
module.exports = {
  ...
  theme: {
    extend: {
      // Add backdrop-blur utilities for glassmorphism
      backdropBlur: {
        'xs': '2px',
        'sm': '4px',
        'md': '8px',
      ...
      // Enhanced animations for beautiful effects
      animation: {
      ...
      boxShadow: {
        ...
        'glass-lg': '0 8px 32px 0 rgba(31, 38, 135, 0.37), 0 4px 16px 0 rgba(0, 0, 0, 0.1)',
        'glass-xl': '0 25px 50px -12px rgba(31, 38, 135, 0.4)',
        'glow': '0 0 20px rgba(59, 130, 246, 0.3)',
        'glow-lg': '0 0 30px rgba(59, 130, 246, 0.5)',
      },
      // Enhanced colors for glass effects
      colors: {
        glass: {
